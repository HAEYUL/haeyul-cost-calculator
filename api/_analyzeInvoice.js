...
const InvoiceSchema = z.object({
  ...
  totalAmount: z
    ...
    .nullable()
    .describe(
      '이번 거래 자체의 총 금액("당일합계", "공급가액 합계", "금액 합계" 등). statementBalance(전잔금까지 포함한 누적 잔액)와는 ' +
        '다른 값이니 혼동하지 마세요. 이번 거래 총액이 표에 따로 적혀있지 않으면 null.',
    ),
  items: z
    .array(
      z.object({
...
- 이번 거래 자체의 총 금액("당일합계", "공급가액 합계" 등. 위 현잔액/총잔금과는 다른, 이번 거래만의 합계입니다)
